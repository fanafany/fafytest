...
from demo import input_record, recognition_speech, tuling_robot
from demo import compound_speech, ouput_redio
...
# 图灵需要的参数
TULING_KEY = '311b0cd44df6401d8c3045518109a959'
...
# 播放图灵回答的内容
ouput_redio.speak(tuling_answer_path)
